Now that we have generators with pruning specific to each problem (see 3 - Problem specific pruning), we can use the generated polyominos to solve the final grid.
